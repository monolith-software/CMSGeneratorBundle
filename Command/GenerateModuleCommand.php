...
use Monolith\Bundle\CMSGeneratorBundle\Generator\ModuleGenerator;
...
class GenerateModuleCommand extends GeneratorCommand
{
    ...
    {
        $questionHelper = $this->getQuestionHelper();
        $questionHelper->writeSection($output, 'Welcome to the Monolith CMS module generator');
        ...
        if (null === $bundle) {
            ...
            $question->setValidator(
                array('Monolith\Bundle\CMSGeneratorBundle\Command\Validators', 'validateBundleName')
            );
