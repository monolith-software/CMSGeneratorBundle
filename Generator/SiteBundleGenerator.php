...
namespace Monolith\Bundle\CMSGeneratorBundle\Generator;
...
class SiteBundleGenerator extends Generator
{
    ...
    public function generate($namespace, $bundle, $dir, $format)
    {
        ...
        $this->renderFile('sitebundle/gitignore.twig', $dir.'/.gitignore', $parameters);
        ...
        $this->renderFile('sitebundle/htaccess_no_Indexes.twig', $dir.'/Resources/public/.htaccess', $parameters);
        $this->renderFile('sitebundle/htaccess_no_Indexes.twig', $dir.'/Resources/public/theme/.htaccess', $parameters);
        ...
        //$this->filesystem->mkdir($dir.'/Resources/public/theme');
    }
}
